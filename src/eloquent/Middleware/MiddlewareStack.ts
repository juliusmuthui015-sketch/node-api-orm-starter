...
export class MiddlewareStack {
    ...
    */
    ...
    removeFromGroup(groupName: string, middleware: string | MiddlewareEntry | Middleware): this {
        const group = this.groups.get(groupName) || [];
        this.groups.set(groupName, group.filter(m => m !== middleware));
        return this;
    }
     ...
     */
    getGroup(name: string, config?: Partial<MiddlewareGroupConfig>): (string | MiddlewareEntry | Middleware)[] {
    ...
    */
     ...
     */
    resolve(middleware: string | MiddlewareEntry | Middleware, args?: string[]): RequestHandler | RequestHandler[] {
