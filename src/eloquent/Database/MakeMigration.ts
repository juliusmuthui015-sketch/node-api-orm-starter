 ...
 */
function parseMigrationName(name: string): { table: string | undefined; action: 'create' | 'alter' | 'drop' } {
...
function getTemplate(name: string, className: string, table: string | undefined, action: 'create' | 'alter' | 'drop'): string {
