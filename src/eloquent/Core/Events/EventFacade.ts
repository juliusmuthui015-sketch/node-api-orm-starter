...
import { EventDispatcher, EventListener, EventSubscriber, getEventDispatcher, setEventDispatcher, ListenerRegistration } from './EventDispatcher';
...
class EventFacadeClass {
    ...
    */
    ...
    static listen(
        ...
        if (typeof event === 'function' && typeof listener === 'function') {
            ...
            const eventName = typeof eventInstance.eventName === 'function'
     ...
     */
    static subscribe(subscriber: EventSubscriber | (new () => EventSubscriber)): typeof EventFacadeClass {
    ...
    */
    ...
    static assertDispatched(
        event: string,
        callback?: ((payload: any) => boolean) | number
    ): void {
