                            ...
                            if (
                                ...
                                if (nestedBuilder) {
                                    ...
                                    if ((nestedBuilder as any).hasConditions && (nestedBuilder as any).hasConditions.length) {
                                        ...
                                        innerActual = await applyNestedHasForRelatedDocs(nestedDocs, nestedBuilder, nestedModel);
                                    } else {
                                ...
                                const pivots2 = await pc2.find({ [foreignPivotKey2]: rd[currentLevelPK] }).toArray();
